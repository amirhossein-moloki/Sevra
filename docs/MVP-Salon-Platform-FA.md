...
## 10) جریان‌های کاربری و صفحات (UI/UX)

### صفحات اصلی پنل
* **داشبورد**: تعداد رزروهای امروز، درآمد امروز، رزروهای پیش‌رو.
* **رزروها (تقویم/لیست)**: مشاهده، ثبت رزرو جدید، تغییر وضعیت، جزئیات.
* **مشتریان**: لیست، جستجوی سریع با موبایل، تاریخچه رزرو.
* **خدمات**: لیست سرویس‌ها، قیمت و مدت زمان.
* **کارکنان**: مدیریت پرسنل، خدمات هر فرد، شیفت کاری.
* **مالی**: گزارش درآمد روزانه و ماهانه، ثبت پرداخت.
* **تنظیمات**: تنظیمات سالن، ساعات کاری، قوانین رزرو.

### اصول تجربه کاربری (UX Guardrails)
* جستجوی سریع مشتری با شماره تلفن.
* جلوگیری از تداخل رزروها در زمان ثبت.
* نمایش فقط زمان‌های خالی بر اساس شیفت کارکن.
