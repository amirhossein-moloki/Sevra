...
- **موارد اجرایی:**
    ...
    - [x] پیاده‌سازی `AuditService` برای ثبت وقایع.
    - [x] لاگ کردن عملیات لغو رزرو، تغییر نقش‌ها و تغییرات مالی.
    - [x] طراحی اندپوینت گزارش‌گیری برای مدیران سالن.
...
- **موارد اجرایی:**
    - [x] تنظیم `SMSIR_API_KEY` و `SMSIR_LINE_NUMBER`. (پشتیبانی کد نویسی شده است)
    - [x] جایگزینی کدهای Mock با وب‌سرویس واقعی `smsir-js`.
    - [x] مدیریت قالب‌های پیامکی (Template IDs).
...
- **موارد اجرایی:**
    - [x] انتقال کوئری‌های Prisma از سرویس‌ها به فایل‌های `.repo.ts`.
...
- **موارد اجرایی:**
    ...
    - [x] حل مشکل دسترسی Docker-in-Docker برای میگریشن‌های Prisma در CI.
    - [x] مانیتورینگ و Sentry (برای آگاهی سریع از خطاهای محیط واقعی).
...
*   **درصد تقریبی تکمیل برای Production-Ready:** ۹۵٪
